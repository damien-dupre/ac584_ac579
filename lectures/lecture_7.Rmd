...
Warning: Time resources in the free plan are limited to 25h of use per month.

If you go beyond, consider installing R and RStudio on your laptop (free option)

```{r out.width='100%'}
include_graphics("https://raw.githubusercontent.com/damien-dupre/img/main/rstudio/posit_cloud_plan.png")
```
...
Two ways to access these slides:
  ...
  - Or from the URL: https://damien-dupre.github.io/ac584_ac579/lectures/lecture_8
