...
1. Open these same slides on a tab to copy-paste the examples
  ...
  - Or from the URL: https://damien-dupre.github.io/ac584_ac579/lectures/lecture_9
...
```{r echo=FALSE, out.width='100%'}
include_graphics("https://miro.medium.com/v2/resize:fit:1400/1*hd6-LkI_sy4b4nu720eV_A.png")
```
