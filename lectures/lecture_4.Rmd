...
[QR code](https://loop.dcu.ie/mod/attendance/password.php?session=78564)
...
## 1. Use **titanic.csv** to explore the following question: “women and children first” or “every man for himself”?

## 2. Create a report that contains **1 Composition Figure**, **1 Comparison Figure** and **1 Relationship Figure** and **pin them on a Power BI dashboard**.

## 3. Pin these 3 visualisation on a Power BI dashboard. Add additional titles containing a text with your story/narrative and an image.
