...
- Will bring you back to the welcome page
--

- The main access to create visualisations and dashboards
--

- List of visualisations and dashboards you previously used or created
--

- List of data you previously used
--

- Create and access "scorecards" (mini dashboards to track data)
--
...
```{r out.width='80%'}
include_graphics("https://cdn-aldpb.nitrocdn.com/MmRYricBGnwFelNvIykEOHWwZuUwjnwj/assets/images/optimized/rev-a60081a/wp-content/uploads/2019/11/powerbi-diagram.png")
```
...
### Go to: Learn (Nav. Pane) -> Sample Report -> Open "Store Sales"
...
## Use **titanic.csv** to create a report in Power BI
