...
# Exercise: Titanic Dashboard

## Use **titanic.csv** to create a Report containing:
- **1 Composition Figure**: Pie chart of % passenger who survived/didn't survive
- **1 Comparison Figure**: Bar chart of % passenger who survived/didn't survive according to Embarkation Location and Gender
- **1 Relationship Figure**: Scatterplot with regression lines between Price of ticket, Age, and Gender 

## Then, pin these 3 visualisation on a Power BI dashboard and add additional titles containing a text with your story/narrative and an image.
