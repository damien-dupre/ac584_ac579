...
.pull-right[
```{r out.width='100%'}
include_img("powerbi_signin.png")
```
]
...
```{r out.width='100%'}
include_img("powerbi_welcome.png")
```
...
```{r out.width='100%'}
include_img("powerbi_create_shortcut.png")
```
...
.pull-right[
```{r out.width='100%'}
include_img("powerbi_excel_data.png")
```
]
...
.pull-right[
```{r out.width='100%'}
include_img("powerbi_enter_data.png")
```
]
...
```{r out.width='100%'}
include_img("powerbi_data_input.gif")
```
...
```{r out.width='90%'}
include_img("powerbi_create.png")
```
...
```{r out.width='20%'}
include_img("powerbi_visualisations.png")
```
...
```{r out.width='100%'}
include_img("powerbi_composition_1.png")
```
...
```{r out.width='100%'}
include_img("powerbi_composition_2.png")
```
...
```{r out.width='100%'}
include_img("powerbi_composition_3.png")
```
...
```{r out.width='100%'}
include_img("powerbi_distribution_1.png")
```
...
```{r out.width='100%'}
include_img("powerbi_distribution_2.png")
```
...
```{r out.width='100%'}
include_img("powerbi_relationship.png")
```
