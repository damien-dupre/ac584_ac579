...
ggplot(organisation_alpha, aes(salary_2019)) +
...
ggplot(organisation_alpha, aes(x = "", y = salary_2019)) +
...
```{r fig.height=3, fig.width=5, fig.align='default'}
ggplot(organisation_alpha, aes(age, salary_2019)) +
  geom_point() +
  labs(x = "Age", y = "Salary") +
  theme_bw() +
  theme(text = element_text(size = 20)) 
...
```{r fig.height=3, fig.width=5, fig.align='default'}
ggplot(organisation_alpha, aes(age, salary_2019, color = gender)) +
  geom_smooth(method = "lm") +
  geom_point() +
  labs(x = "Age", y = "Salary") +
  theme_bw() +
...
- [Learn Power BI Basics for Free](https://www.udemy.com/course/learn_power_bi_for_free/)
